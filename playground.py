...
def make_sponsor_message() -> Panel:
    ...
    sponsor_message.add_row(
        "Your Aid:",
        "[blue]The people are rioting, the people are starving, the people are dying. What would you like to do??[/ blue]",
    )

    sponsor_message.add_row(
        "Your Choices:",
        "[u yellow]Give them the money they deserve[/u yellow] or [u red]Order the natinal guard to exterminate them all!![/u red]",
    )
    ...
    message_panel = Panel(
        ...
        box=box.ROUNDED,
        padding=(1, 2),
        title="[b red]What Will You Decide Next, Pick Wisely...[/b red]",
...
job_progress.add_task("[green]Satisfaction")
job_progress.add_task("[magenta]Economy", total=200)
job_progress.add_task("[cyan]Stability", total=400)
...
progress_table.add_row(
    ...
    Panel(job_progress, title="[b]Stats", border_style="red", padding=(1, 2)),
)
